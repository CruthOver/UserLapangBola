...
public class InfoPagerAdapter extends PagerAdapter {
    ...
    private AdapterListener<Info> listener;

    public InfoPagerAdapter(Context context, List<Info> dataList, AdapterListener<Info> listener) {
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        final Info data= dataList.get(position);
        ...
        picasso.load(UtilsApi.BASE_URL+data.getPhotoUrl())
                .placeholder(R.color.underline)
                .error(R.color.underline)
                .into(imageView);
